CONSTANTS = {
    "INITIAL_PROMPT": {
        "en": ("I want you to be my system analyst for software product. I will ask you questions "
               ...
               "use strict definitions. Pretend you are a system analyst who is reading files by himself, so do not "
               "tell me that I provided you these files. After all questions, I will ask one general question about "
               "the project summary. In the answer to that question, I want the summary info about the project "
        ...
        "ru": ("Я хочу, чтобы ты был моим системным аналитиком для программного продукта. "
               ...
               "никаких предположений, используй строгие определения. Притворись, что ты системный аналитик, который"
               "сам анализирует файлы, поэтому не говори мне что это я предоставил тебе файлы. После всех вопросов я "
               "задам один общий вопрос о сводке проекта. В ответе на этот вопрос я хочу получить общую информацию о "
               "проекте на основе твоих предыдущих ответов о файлах.")
    },
    "FILE_QUESTION": {
